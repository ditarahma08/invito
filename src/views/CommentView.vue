        ...
        <div class="flex justify-center items-center mb-10">
          ...
          >
            ...
            <div class="flex justify-end">
              <button
                type="submit"
                :disabled="!form.wishes || !form.name || !form.company"
                class="px-4 py-2 bg-red-800 text-white rounded-md hover:bg-red-800"
                :class="{
                  'opacity-50 cursor-not-allowed':
                    !form.wishes || !form.name || !form.company,
                }"
              >
                Submit
              </button>
      ...
      <div class="flex">
        <div class="grid grid-cols-1 gap-6">
          <div class="flex space-x-6 overflow-x-auto">
            <div
              class="bg-white p-6 rounded-lg shadow-lg flex-none w-80"
